...
const page = () => {
  return (
    <main className="pt-[10vh] bg-black text-white">
      ...
      <section className="md:h-screen text-[2rem] md:text-[6rem] text-center font-bold p-4 md:p-10 text-white">
        Our Agency brings creativity, innovation, and relentless drive to your
        business.
      </section>

      <section className=" text-[2rem] md:text-[6rem] font-bold text-center p-4 md:p-10 my-8 md:leading-[6.5rem] text-white">
